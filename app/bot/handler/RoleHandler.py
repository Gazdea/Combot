...
# async def role_add(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
...
#
# async def role_delete(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
...
#
# async def role_command_add(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
...
#
# async def role_command_delete(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
...
#
# async def role_rename(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
